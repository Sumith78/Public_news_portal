...
<div>
    <div class="row">
                    ...
                    <form action="./signup" method="post">
                        <div class="form-group">
                            <input type="text" name="Ruser" class="form-control input-sm" placeholder="Username" pattern="[a-zA-Z]+" title="Please enter a valid name with no digits." required/>
                                ...
                                <div class="form-group">
                                    <input type="text" name="Rname" class="form-control input-sm floatlabel" placeholder="Name" pattern="[a-zA-Z]+" title="Please enter a valid name with no digits." required/>
                                </div>
        ...
        <div class ="form-group">
            <input type="number" name="Rmobile" class="form-control input-sm" placeholder="Mobile Number" pattern="\d{10}" title="Please enter a 10-digit contact number." required/>
	</div>
